...
function Context({children}) {
  ...
  e.preventDefault();
  try {
    let StudentRecords = await axios.post("https://collegemanagementsystem-backend.onrender.com/addStudent", {
      StudentName,
      StudentAge,
      StudentBranch,
      StudentGender,
...
async function StudentDetails() {
  try{
      let StudentDetails=await axios.get('https://collegemanagementsystem-backend.onrender.com/GettingStudent')
...
async function UpdateStudent(e) {
  e.preventDefault()
  try{
    let UpdateStudent= await axios.put(`https://collegemanagementsystem-backend.onrender.com/UpdateStudent/${Uid}`,{
...
async function DeleteStudent(id) {
  try{
    let DeleteStudent= await axios.delete(`https://collegemanagementsystem-backend.onrender.com/DeleteStudent/${id}`)
...
let StudentRecordsLower=StudentsRecords.filter((x,y)=>{
  ...
  //ASYNC FUNCTION TO SENDING TEACHERS DATA
    async function TeachersData(e) {
      e.preventDefault()
      try{
        let TeachersData=await axios.post('https://collegemanagementsystem-backend.onrender.com/TeacherAdd',{TeachersName,TeachersDept,TeachersAge,TeachersQualification,TeacherAddress,TeachersDob,TeacherGender,TeacherBloodGrp,TeacherSalary,})
  ...
  async function TeacherDetails() {
   try{
     let TeachersDataBk= await axios.get('https://collegemanagementsystem-backend.onrender.com/GetTeacher')
  ...
  async function UpdateTeachers(e) {
    e.preventDefault()
    try{
      let UpdatedTeachers=await axios.put(`https://collegemanagementsystem-backend.onrender.com/UpdateTeachers/${UpdateTeachersId}`,{
  ...
  async function TeachersDelete(id) {
    try{
      let DeleteTeacher=await axios.delete(`https://collegemanagementsystem-backend.onrender.com/DeleteTeachers/${id}`)
